...
if ($result->num_rows > 0)
{
    while ($row=$result->fetch_assoc())
    {
        ...
        <hr>
        <div class="heading">
            <h3 class="text-center">Registration Delete</h3>
        </div>
        <hr>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <br>
                        <input type="text" name="nok_telephone" class="form-control" required value="<?php echo $row['nok_tel']?>">
                    </div>
                    <div class="col-sm-4">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <br>
                        <input type="text" name="edu_level" class="form-control" required value="<?php echo $row['education_level']?>">
                    </div>
                    <div class="col-sm-4">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <br>
                        <input type="date" name="yrFrom" class="form-control" required value="<?php echo $row['year_from']?>">
                    </div>
                    <div class="col-sm-4">
                        <label for=""><b>Year To : </b></label>
                        <br>
                        <input type="date" name="yrTo" class="form-control" required value="<?php echo $row['year_to']?>">
                    </div>
                    <div class="col-sm-4">
